...
const ChrestmasCategory = () => {
  ...
  <ul style={{ listStyle: 'none', padding: '9', marginTop: '2rem' }}>
    ...
    <img src={birthdayImage} alt="Happy Birthday" style={{ width: '30px', marginRight: '10px' }} />     
     ...
     <Link to="/birthday-gifts">Birthday</Link>
    </li>
    <li style={{ marginBottom: '80px', cursor: 'pointer', display: 'flex', alignItems: 'center' }}>
    <img src={christmasImage} alt="christmas" style={{ width: '30px', marginRight: '10px' }} />
      <Link to="/christmas-gifts">Christmas</Link>
    </li>
    <li style={{ marginBottom: '80px', cursor: 'pointer', display: 'flex', alignItems: 'center' }}>
    <img src={weddingImage} alt="christmas" style={{ width: '30px', marginRight: '10px' }} />
      <Link to="/wedding-gifts">Wedding</Link>
    </li>
 
    <li style={{ marginBottom: '80px', cursor: 'pointer', display: 'flex', alignItems: 'center' }}>
    <img src={winterImage} alt="winter" style={{ width: '30px', marginRight: '10px' }} />
      <Link to="/winter-gifts">Winter</Link>
    </li>
  </ul>
</aside>
            ...
            <div key={item.id} style={{ maxWidth: '18rem', marginBottom: '2rem' }}>
              <Link to={`/product/${item.id}`}>
                <img
                  ...
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJPnwfPGSyl2gpYVdtVPulHWVVGSg-Oowyog&usqp=CAU"
                  alt={item.title}
                />
              </Link>
...
export default ChrestmasCategory;
