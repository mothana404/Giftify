            ...
            <div key={item.id} style={{ maxWidth: '18rem', marginBottom: '2rem' }}>
              <Link to={`/product/${item.id}`}>
                <img
                  ...
                  src="https://deavita.net/wp-content/uploads/2022/12/a-box-full-of-happiness-christmas-spirit-chocolate-candies-biscuits-cute-cup-sweets.webp"
                  alt={item.title}
                />
              </Link>
...
export default ChristmasPackge;
